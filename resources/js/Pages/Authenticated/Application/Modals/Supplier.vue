    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title mt-0" id="myModalLabel">Manage Supplier Details</h5>
                        ...
                        <div class="row">
                            ...
                            <div class="col-8">
                                <div class="row">
                                    ...
                                    <div class="col-8">
                                        <select v-model="current.status" id="" class="form-control custome-select" :disabled="!disableField">
            ...
            <form action="" method="post" @submit.prevent="saveSupplier" v-else>
                <div class="modal-body">
                    <div class="row">
                        <div class="col-lg-12 col-md-12">
                            <div class="form-group" >
                                <div class="input-group mb-2">
                                    ...
                                    <input class="form-control" required  type="text"  v-model="current.name" placeholder="Supplier name">
                                </div>
                                <div class="input-group mb-2">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text">
                                    ...
                                    <input class="form-control" required type="text"  v-model="current.address" placeholder="Supplier Address">
                                </div>
                                <div class="input-group mb-2">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text">
                                    ...
                                    <input class="form-control" required type="text"  v-model="current.phone" placeholder="Phone number">
                                </div>
                                <div class="input-group mb-2">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text">
                                    ...
                                    <input class="form-control" required type="text"  v-model="current.item" placeholder="Items To be Purchased">
                                </div>
                                <div class="input-group mb-2">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text">
                                    ...
                                    <input class="form-control" required type="number"  v-model="current.amount" placeholder="Amount in Number(350000)">
                                </div>
                                <div class="input-group mb-2">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text">
                                    ...
                                    <input class="form-control" required type="text"  v-model="current.description" placeholder="Description of Goods to be purchased">
                                </div>
                                ...
                                <div class="input-group mb-2">
                                    ...
                                    <select class="form-control" required v-model="current.goods_type">
                                        <option value="">--Select Goods Type--</option>
                                        <option value="automobile">AUTOMOBILE / VEHICLE LEASE</option>
                                        <option value="home appliance">HOME APPLIANCES / FURNITURE</option>
                                        <option value="office equipment">OFFICE EQUIPMENT</option>
                                        <option value="medical">MEDICAL / HOSPITAL EQUIPMENT</option>
                                ...
                                <div class="input-group mb-2">
                                    ...
                                    <select class="form-control" required v-model="current.payment_spread">
                                ...
                                <div>
                                    <p style="color:red;">How Much Advance Rentals are you willing to make for 
                                        this leasing Application? Please note Automobile/Vehicle Leasing has a mandatory 
                                ...
                                <div class="input-group mb-2">
                                    ...
                                    <select class="form-control" required v-model="current.advance_rentals">
...
export default {
    ...
    methods : {
        ...
        saveSupplier(){
            axios.post('/saveSupplier?appId='+this.application_id, this.current)
                .then(res=>{
