                                                ...
                                                <div class="col-lg-6 col-md-12">
                                                    ...
                                                    <div class="form-group" >
                                                        <div class="input-group">
                                                            ...
                                                            <input class="form-control" type="number" required v-model="form.id_number" placeholder="Identity Number">
                                                        </div>
                                                    </div>
                                                </div>
                                                    <div class="col-lg-6 col-md-12">
        ...
        methods : {
            getApplication(){
                ...
                if (appId != null) {
                    this.loading = true;
                    axios
                    .post('/get-application',{app_id:appId})
                    .then(res =>{
                        this.form = res.data;
                    this.loading = false;
